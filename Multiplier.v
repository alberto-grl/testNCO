...
/* Module Version: 4.9 */
/* C:\lscc\diamond\3.14\ispfpga\bin\nt64\scuba.exe -w -n Multiplier -lang verilog -synth lse -bus_exp 7 -bb -arch xo2c00 -type dspmult -simple_portname -pfu_mult -widtha 10 -widthb 10 -widthp 20 -signed -PL_stages 1 -input_reg -output_reg -clk0 -ce0 -rst0  */
...
module Multiplier (Clock, ClkEn, Aclr, DataA, DataB, Result)/* synthesis NGD_DRC_MASK=1 */;
    ...
    FD1P3DX FF_43 (.D(Multiplier_0_pp_0_0), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_0_0))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_42 (.D(Multiplier_0_pp_0_1), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_0_1))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_41 (.D(s_Multiplier_0_0_2), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_2))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_40 (.D(s_Multiplier_0_0_3), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_3))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_39 (.D(s_Multiplier_0_0_4), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_4))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_38 (.D(s_Multiplier_0_0_5), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_5))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_37 (.D(s_Multiplier_0_0_6), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_6))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_36 (.D(s_Multiplier_0_0_7), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_7))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_35 (.D(s_Multiplier_0_0_8), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_8))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_34 (.D(s_Multiplier_0_0_9), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_9))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_33 (.D(s_Multiplier_0_0_10), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_10))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_32 (.D(s_Multiplier_0_0_11), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_11))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_31 (.D(s_Multiplier_0_0_12), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_12))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_30 (.D(s_Multiplier_0_0_13), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_13))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_29 (.D(s_Multiplier_0_0_14), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_14))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_28 (.D(s_Multiplier_0_0_15), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_0_15))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_27 (.D(Multiplier_0_pp_2_4), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_2_4))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_26 (.D(Multiplier_0_pp_2_5), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_2_5))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_25 (.D(s_Multiplier_0_1_6), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_6))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_24 (.D(s_Multiplier_0_1_7), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_7))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_23 (.D(s_Multiplier_0_1_8), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_8))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_22 (.D(s_Multiplier_0_1_9), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_9))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_21 (.D(s_Multiplier_0_1_10), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_10))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_20 (.D(s_Multiplier_0_1_11), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_11))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_19 (.D(s_Multiplier_0_1_12), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_12))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_18 (.D(s_Multiplier_0_1_13), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_13))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_17 (.D(s_Multiplier_0_1_14), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_14))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_16 (.D(s_Multiplier_0_1_15), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_15))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_15 (.D(s_Multiplier_0_1_16), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_16))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_14 (.D(s_Multiplier_0_1_17), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_17))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_13 (.D(s_Multiplier_0_1_18), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_18))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_12 (.D(s_Multiplier_0_1_19), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_s_Multiplier_0_1_19))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_11 (.D(Multiplier_0_pp_4_8), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_8))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_10 (.D(Multiplier_0_pp_4_9), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_9))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_9 (.D(Multiplier_0_pp_4_10), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_10))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_8 (.D(Multiplier_0_pp_4_11), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_11))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_7 (.D(Multiplier_0_pp_4_12), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_12))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_6 (.D(Multiplier_0_pp_4_13), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_13))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_5 (.D(Multiplier_0_pp_4_14), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_14))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_4 (.D(Multiplier_0_pp_4_15), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_15))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_3 (.D(Multiplier_0_pp_4_16), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_16))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_2 (.D(Multiplier_0_pp_4_17), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_17))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_1 (.D(Multiplier_0_pp_4_18), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_18))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_0 (.D(Multiplier_0_pp_4_19), .SP(ClkEn), .CK(Clock), .CD(Aclr), 
        .Q(f_Multiplier_0_pp_4_19))
             /* synthesis GSR="ENABLED" */;
    ...
    FADD2B Cadd_Multiplier_0_2_1 (.A0(scuba_vlo), .A1(f_s_Multiplier_0_0_4), 
        .B0(scuba_vlo), .B1(f_Multiplier_0_pp_2_4), .CI(scuba_vlo), .COUT(co_Multiplier_0_2_1), 
    ...
    FADD2B Multiplier_0_add_2_7 (.A0(f_s_Multiplier_0_0_15), .A1(scuba_vlo), 
    ...
    FADD2B Multiplier_0_add_2_8 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(f_s_Multiplier_0_1_17), 
        .B1(f_s_Multiplier_0_1_18), .CI(co_Multiplier_0_2_7), .COUT(co_Multiplier_0_2_8), 
        .S0(s_Multiplier_0_2_17), .S1(s_Multiplier_0_2_18));

    FADD2B Multiplier_0_add_2_9 (.A0(scuba_vlo), .A1(scuba_vlo), .B0(f_s_Multiplier_0_1_19), 
    ...
    FADD2B Cadd_t_Multiplier_0_3_1 (.A0(scuba_vlo), .A1(s_Multiplier_0_2_8), 
        .B0(scuba_vlo), .B1(f_Multiplier_0_pp_4_8), .CI(scuba_vlo), .COUT(co_t_Multiplier_0_3_1), 
        .S0(), .S1(rego_o_8));
    ...
    FADD2B t_Multiplier_0_add_3_7 (.A0(s_Multiplier_0_2_19), .A1(scuba_vlo), 
        .B0(f_Multiplier_0_pp_4_19), .B1(scuba_vlo), .CI(co_t_Multiplier_0_3_6), 
