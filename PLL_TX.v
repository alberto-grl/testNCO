...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n PLL_TX -lang verilog -synth synplify -arch xo2c00 -type pll -fin 22 -fclkop 22 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1  */
/* Mon Oct 28 17:03:13 2024 */


`timescale 1 ns / 1 ps
module PLL_TX (CLKI, CLKOP)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOP="22.000000" */
             /* synthesis FREQUENCY_PIN_CLKI="22.000000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 22.000000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKI 22.000000
